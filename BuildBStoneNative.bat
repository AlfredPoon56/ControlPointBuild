...
Rem Set Documentation version to 5.2 for now.  (Leave it blank for now)
set DocVer=5.2

Rem Set the SPVersion to Arg2
set spver=%2

rem Arg 2 is for sp2013 or sp2010 build. (2013) or (2010)
if "%spver%"=="2010" set VSVersion=2010
if "%spver%"=="2013" set VSVersion=2012
...
Call "C:\ControlPoint_build\ExecuteBuild.bat" TFS apoon 0507.2010 20100507 BlackStone_%spver%_Native %1_N  $/SharePointDev %VSVersion%
...
xcopy /y %SaDb% \\axstore\Development\Builds\ControlPoint\BlackStone_%spver%_Native\SA_Map_Database\*.*
