...
Call "C:\ControlPoint_build\ExecuteBuild.bat" TFS apoon 0507.2010 20100507 VNext_%spver%_Native %1_N  $/SharePointDev %VSVersion%
...
xcopy /y %SaDb% \\axstore\Development\Builds\ControlPoint\VNext_%spver%_Native\SA_Map_Database\*.*
