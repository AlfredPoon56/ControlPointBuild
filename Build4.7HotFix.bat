...
set cpver=
set cpBranch=ControlPointV4.7-Cust
set GetFromLabel=
...
Call "C:\ControlPoint_build\ExecuteBuild.bat" TFS apoon 0507.2010 20100507 Nero_%spver% %1  $/SharePointDev 2010
...
xcopy /y %SaDb% \\axstore\Development\Builds\ControlPoint\Nero_%2\SA_Map_Database\*.*
