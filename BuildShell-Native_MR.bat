...
set cpver=
set cpBranch=CPShell-Native_MR
set GetFromLabel=
set PURE=Pure
set Obfuscate=NO
...
Call "C:\ControlPoint_build\ExecuteBuild.bat" TFS apoon 0507.2010 20100507 CP5.0.1-MR_%spver%_Native %1  $/SharePointDev 2010
...
xcopy /y %SaDb% \\axstore\Development\Builds\ControlPoint\CP5.0.1_%spver%_Native\SA_Map_Database\*.*
