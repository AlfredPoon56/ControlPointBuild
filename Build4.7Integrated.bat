...
Call "C:\ControlPoint_build\ExecuteBuild.bat" TFS apoon 0507.2010 20100507 Nero_%spver%_Integrated %1  $/SharePointDev 2010
...
xcopy /y %SaDb% \\axstore\Development\Builds\ControlPoint\Nero_%2_Integrated\SA_Map_Database\*.*
