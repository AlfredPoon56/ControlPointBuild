...
"C:\Program Files (x86)\Microsoft Visual Studio 10.0\Common7\IDE\devenv" "C:\Program Files\Common Files\Microsoft Shared\web server extensions\14\TEMPLATE\LAYOUTS\axceler\PTAdmin\ControlPointBuild2010.sln" /BUILD Release >> %buildfile%
